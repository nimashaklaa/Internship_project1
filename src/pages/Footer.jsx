            ...
            <div className="wrap-footer">
                ...
                <div className="form-block">
                    <InputText
                        ...
                        state="default"
                    />
                    <Button className="button-instance" label={"REMIND"} state="default" type="primary"/>   
                </div>
            </div>
            <div className="wrap-footer-2">
                ...
                <div className="Social-links">
                    ...
                    <div className="social-m-link">
                        <img className="instergram" alt="instegram" src="instegram.svg"/>
                        <img className="Pinterest" alt="Pinterest" src="Pinterest.svg"/>
